...
public class Board {
    ...
    public Board(int width, int height) {
        ...
        heights = new int[width]; // store index of the open spot which is just
                                  // above the top filled spot
        widths = new int[height]; // widths store how many filled spots there
                                  // are in each row
        maxHeight = 0;
        // below are state for undo
        committed = true;
